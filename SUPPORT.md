...
Thanks for using sntutils! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/ahadi-analytics/sntutils/issues/new).
...
requests](https://github.com/ahadi-analytics/sntutils/issues) to make
