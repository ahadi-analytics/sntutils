...
paths$admin_shp
#> /tmp/RtmpYhbAvl/01_data/1.1_foundational/1.1a_admin_boundaries
paths$val_fig
#> /tmp/RtmpYhbAvl/03_outputs/3.1_validation/figures
paths$interm_tbl
#> /tmp/RtmpYhbAvl/03_outputs/3.2_intermediate_products/tables
```
