...
paths$admin_shp
#> /tmp/Rtmpn8CWUk/01_data/1.1_foundational/1.1a_admin_boundaries
paths$val_fig
#> /tmp/Rtmpn8CWUk/03_outputs/3.1_validation/figures
paths$interm_tbl
#> /tmp/Rtmpn8CWUk/03_outputs/3.2_intermediate_products/tables
```
