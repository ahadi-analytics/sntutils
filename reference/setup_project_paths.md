...
paths$admin_shp
#> /tmp/RtmpJcrYJl/01_data/1.1_foundational/1.1a_admin_boundaries
paths$val_fig
#> /tmp/RtmpJcrYJl/03_outputs/3.1_validation/figures
paths$interm_tbl
#> /tmp/RtmpJcrYJl/03_outputs/3.2_intermediate_products/tables
```
