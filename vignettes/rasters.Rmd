...
> [Climate article's mapping section](climate.html#mapping-small-area-climate-estimates)
> for a worked example using `facetted_map_gradient()` and the
> `get_palette()` colour helpers. The same recipe works for any
> raster-extracted tibble.
