...
This outlines how to propose a change to sntutils. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ahadi-analytics/sntutils", fork = TRUE)`.
...
Please note that the sntutils project is released with a [Contributor
Code of
Conduct](https://ahadi-analytics.github.io/sntutils/CODE_OF_CONDUCT.md).
