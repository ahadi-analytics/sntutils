...
**Scenario 1: Facility-Level Reporting Rate**
...
- `vars_of_interest` = variables used to determine if a facility has reported during a given time period e.g. "conf", "pres"
...
**Scenario 2: Reporting/Missing Rates Over Time**
...
**Scenario 2: Reporting Rates Over Time**
